  ...
  const layers = ([
    ...
    },
    {
      ...
      content: [
        ...
        'actionBundle proposal top-level fields: userPlanMarkdown, codeBlocks, actionBundle. The nested actionBundle object must include version/id/goal/actions/continuationExpectations/validationExpectations/reviewExpectations; goal is a short batch objective, not a permission grant or execution fact. validationExpectations[] and reviewExpectations[] are the only provider-facing validation/review note carriers. actionBundle is for Complete stage after acceptedTaskPlan context unless the user explicitly asked for a tiny single-step side effect.',
        ...actionBundleProtocolShapeLines(),
