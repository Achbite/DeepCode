  ...
  const layers = ([
    {
      ...
      content: [
        ...
        'For requirement understanding before executable work, use kind="requirementDraft" only and do not output codeBlocks or actionBundle.',
        'Side-effect actionBundle.userPlan must be detailed Markdown with exactly these top-level sections: Summary, Key Changes, Interfaces, Test Plan, Assumptions.',
    ...
    },
    {
      ...
      content: [
        ...
        'Agent Protocol v3 requirement draft shape: {"schemaVersion":"deepcode.agent.protocol.v3","kind":"requirementDraft","outputLanguage":"zh-CN","requirementDraft":{"version":"1","requirementId":"req-...","summary":"...","goal":"...","scope":["..."],"outOfScope":["..."],"constraints":["..."],"risks":["..."],"acceptanceCriteria":["..."],"openQuestions":["..."]}}',
        ...
        'Agent Protocol v3 action bundle shape: {"schemaVersion":"deepcode.agent.protocol.v3","kind":"actionBundle","outputLanguage":"zh-CN","userPlan":"# Plan\\n\\n## Summary\\n...\\n\\n## Key Changes\\n- ...\\n\\n## Interfaces\\n- ...\\n\\n## Test Plan\\n- ...\\n\\n## Assumptions\\n- ...","codeBlocks":[{"id":"...","path":"<workspace-resource>","content":"..."}],"actionBundle":{"version":"1","id":"...","goal":"...","actions":[{"id":"...","title":"...","capability":"workspace.write","kind":"write","resourceScope":["<workspace-resource>"],"sourceBlockId":"..."}],"continuationExpectations":[{"id":"next-batch","title":"Continue with the next reviewable implementation batch after user approval","capability":"workspace.write","kind":"write","resourceScope":["<workspace-resource>"]}],"validationExpectations":[{"id":"files-written","description":"Kernel records write facts for every planned file and the final review can inspect the changed paths."}],"reviewExpectations":[{"id":"user-review","description":"User reviews this batch scope, generated files, and validation evidence before accepting completion."}]},"expectedValidation":"...","reviewGuide":"..."}',
