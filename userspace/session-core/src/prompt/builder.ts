  ...
  const layers = ([
    ...
    },
    {
      ...
      content: [
        ...
        'resourceRequest.items[] must include either manifestEntryId, path, or kind="search"+query. Use path only for files or directories under listed conversation roots or explicit user attachments. For file segments, include optional offsetBytes and limitBytes. For search, query must be non-empty; include/contextLines/maxResults are optional bounded hints.',
