  ...
  const layers = ([
    ...
    },
    {
      ...
      content: [
        ...
        'decisionRequest top-level field: decisionRequest.version/id/reason/summary/options/allowsFreeform; use 2-3 mutually exclusive options with one recommended option. Options may declare effect.kind from continueWithAction, skipCurrentTask, markTasksCompleted, markAcceptedIncomplete, replan, finishWithAnswer, cancel.',
