  ...
  const layers = ([
    {
      ...
      content: [
        ...
        'If the user requests write, user review, then delete, the first actionBundle only writes and waits for review; delete is a separate later plan.',
    ...
    },
    {
      ...
      content: [
        ...
        'JSON Envelope v2 resource request shape: {"schemaVersion":"deepcode.agent.protocol.v2","kind":"resourceRequest","outputLanguage":"zh-CN","resourceRequest":{"version":"1","id":"...","reason":"...","items":[]}}',
        'JSON Envelope v2 action bundle shape: {"schemaVersion":"deepcode.agent.protocol.v2","kind":"actionBundle","outputLanguage":"zh-CN","userPlan":"...","codeBlocks":[{"id":"...","path":"...","content":"..."}],"actionBundle":{"version":"1","id":"...","goal":"...","actions":[{"id":"...","title":"...","capability":"workspace.write","kind":"write","resourceScope":["test.md"],"sourceBlockId":"..."}],"validationExpectations":[],"reviewExpectations":[]},"expectedValidation":"...","reviewGuide":"..."}',
