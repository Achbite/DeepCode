    ...
    return [
      ...
      },
      {
        ...
        content: [
          ...
          'Repair requirement:',
          fenced('Return a corrected actionBundle for the current accepted task. Set outputLanguage from the current user language. Prefer currentTaskActionTemplates from the accepted task context when present. Minimal patch shape: {"schemaVersion":"deepcode.agent.protocol.v3","kind":"actionBundle","outputLanguage":"<current-user-language>","userPlanMarkdown":"# Plan\\n\\n## Summary\\n...","codeBlocks":[{"blockId":"block-1","targetPath":"relative/file.ext","contentLines":["replacement line"]}],"actionBundle":{"version":"1","id":"batch-id","goal":"...","actions":[{"actionId":"patch-file","toolId":"fs.patch","args":{"path":"relative/file.ext","replacementBlockId":"block-1","patchSpec":{"match":{"kind":"exactBlock","text":"..."}}},"description":"..."}]}}. DecisionRequest minimal shape for material user choices only: {"schemaVersion":"deepcode.agent.protocol.v3","kind":"decisionRequest","outputLanguage":"<current-user-language>","decisionRequest":{"version":"1","id":"choice","question":"...","options":[{"id":"continue-current-task","label":"...","description":"...","recommended":true,"effect":{"kind":"continueCurrentTask"}},{"id":"revise-plan","label":"...","description":"...","effect":{"kind":"replan","reason":"revise accepted plan"}}],"allowsFreeform":true}}. Do not add accessScopes/resourceScope/capability/commandBlocks/payload wrapper. If current patch evidence is missing, return resourceRequest search/read first. Do not use decisionRequest for routine permission or scope expansion; Session deterministic validation handles those gates.'),
        ].join('\n\n'),
      },
    ];
  }
