#!/usr/bin/env bash
# DeepCode repository verification entrypoint.
# Full Rust, TypeScript, Session, daemon, Host Web, and IPC checks run in Docker.
# A macOS/Linux host invocation performs only static shell and architecture checks.
set -euo pipefail
