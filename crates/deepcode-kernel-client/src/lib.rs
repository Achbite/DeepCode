...
pub use conversation::{
    ...
    AssistantDraftProjection, AttachConversationDirectoryIndexRequest, CommandReply,
    ContextCompositionItem, ContextCompositionMessage, ContextCompositionMessageBlock,
