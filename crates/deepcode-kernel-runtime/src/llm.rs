...
pub(crate) fn compile_kernel_phase_instruction(
    ...
    let mut prompt = format!(
        ...
        Minimal valid resource request example: {{\"schemaVersion\":\"deepcode.agent.protocol.v2\",\"kind\":\"resourceRequest\",\"outputLanguage\":\"en-US\",\"resourceRequest\":{{\"version\":\"1\",\"id\":\"need-target\",\"reason\":\"Need a concrete target resource.\",\"items\":[{{\"id\":\"target-file\",\"manifestEntryId\":\"current-selection\",\"reason\":\"Resolve the user-selected file.\"}}]}}}}\n\
